 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.netlist.model.concise.Net#getPins <em>Pins</em>}</li>
 * </ul>
 *
 * @see org.eclipse.epsilon.netlist.model.concise.ConcisePackage#getNet()
 * @model
 * @generated
 */
public interface Net extends NamedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.eclipse.epsilon.netlist.model.concise.Pin#getNet <em>Net</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Pins</em>' reference list.
	 * @see org.eclipse.epsilon.netlist.model.concise.ConcisePackage#getNet_Pins()
