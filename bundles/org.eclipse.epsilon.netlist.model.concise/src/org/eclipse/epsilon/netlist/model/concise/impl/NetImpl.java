 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.netlist.model.concise.impl.NetImpl#getPins <em>Pins</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetImpl extends NamedElementImpl implements Net {
	...
	protected EClass eStaticClass() {
		return ConcisePackage.Literals.NET;
	}
	...
	public EList<Pin> getPins() {
		if (pins == null) {
			pins = new EObjectWithInverseResolvingEList<Pin>(Pin.class, this, ConcisePackage.NET__PINS, ConcisePackage.PIN__NET);
		}
		return pins;
	}
