 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.netlist.model.concise.impl.NetlistImpl#getNets <em>Nets</em>}</li>
 *   <li>{@link org.eclipse.epsilon.netlist.model.concise.impl.NetlistImpl#getComponents <em>Components</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetlistImpl extends MinimalEObjectImpl.Container implements Netlist {
	...
	protected EClass eStaticClass() {
		return ConcisePackage.Literals.NETLIST;
	}
	...
	public EList<Net> getNets() {
		if (nets == null) {
			nets = new EObjectContainmentEList<Net>(Net.class, this, ConcisePackage.NETLIST__NETS);
		}
		return nets;
	}
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<Component>(Component.class, this, ConcisePackage.NETLIST__COMPONENTS);
		}
		return components;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConcisePackage.NETLIST__NETS:
				return ((InternalEList<?>)getNets()).basicRemove(otherEnd, msgs);
			case ConcisePackage.NETLIST__COMPONENTS:
