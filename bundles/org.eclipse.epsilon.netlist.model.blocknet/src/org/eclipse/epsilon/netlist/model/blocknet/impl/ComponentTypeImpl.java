 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.netlist.model.blocknet.impl.ComponentTypeImpl#getInstances <em>Instances</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentTypeImpl extends NamedElementImpl implements ComponentType {
	...
	protected EClass eStaticClass() {
		return BlocknetPackage.Literals.COMPONENT_TYPE;
	}
	...
	public EList<Component> getInstances() {
		if (instances == null) {
			instances = new EObjectWithInverseResolvingEList<Component>(Component.class, this, BlocknetPackage.COMPONENT_TYPE__INSTANCES, BlocknetPackage.COMPONENT__TYPE);
		}
		return instances;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BlocknetPackage.COMPONENT_TYPE__INSTANCES:
