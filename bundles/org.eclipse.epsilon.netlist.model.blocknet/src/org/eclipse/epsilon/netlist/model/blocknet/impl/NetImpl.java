 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.netlist.model.blocknet.impl.NetImpl#getPins <em>Pins</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetImpl extends NamedElementImpl implements Net {
	...
	protected EClass eStaticClass() {
		return BlocknetPackage.Literals.NET;
	}
	...
	public EList<Pin> getPins() {
		if (pins == null) {
			pins = new EObjectWithInverseResolvingEList<Pin>(Pin.class, this, BlocknetPackage.NET__PINS, BlocknetPackage.PIN__NET);
		}
		return pins;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BlocknetPackage.NET__PINS:
